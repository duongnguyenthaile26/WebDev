...
--> Hiện tại search sau khi search tên thì chỉ filter theo được 1 category. Kiếm cách chọn 2 3 cái rồi nhưng nó lại bị chặn event.preventDefault(). Th nào có cách fix giùm t với, lú quá r.
--> oke để t xem
